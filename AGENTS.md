...
* Never forget to commit frequently and follow conventional commit; Never push anything, Julien will do it, always.
* When you create changes/commits, you have to update the app version in src/syncagent/__init__.py according to semver convention
